    ...
    Tables: {
      ...
      jobs: {
        Row: {
          ...
          video_id: string
          user_id: string
          status: 'queued' | 'extracting_audio' | 'transcribing' | 'detecting_segments' | 'processing_video' | 'burning_subtitles' | 'uploading' | 'completed' | 'failed'
          progress: number
...
export type JobStatus = 'queued' | 'extracting_audio' | 'transcribing' | 'detecting_segments' | 'processing_video' | 'burning_subtitles' | 'uploading' | 'completed' | 'failed'
